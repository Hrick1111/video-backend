...
const getAllVideos = asyncHandler(async (req, res) => {
    // fetching 10 pages
    // looking up in the database using aggregate piples
    // using subpipleines to look for publisher details of the video
    // added new fields named details which adds th details of the videos fetched
    // returing response 
